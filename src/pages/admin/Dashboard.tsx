    ...
    >
      ...
      >
        <button
          ...
          className="absolute inset-0 h-full w-full rounded-3xl border border-border bg-card p-6 text-left outline-none [backface-visibility:hidden] focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
        >
          {children}
        </button>
        ...
        <div
          ...
          className="absolute inset-0 flex h-full w-full cursor-pointer flex-col justify-between rounded-3xl border border-border bg-card p-6 outline-none [backface-visibility:hidden] [transform:rotateY(180deg)] focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
        >
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Open the full {routeLabel} page for details, filters, and actions.
            </p>

            <p className="mt-3 text-xs text-muted-foreground">
              Tap this card again to return.
            </p>
          </div>
    ...
    <div className="mx-auto w-full max-w-7xl px-4 py-8 pb-32 sm:px-6 lg:px-8 lg:pb-10">
      ...
      >
        <FlipCommandCard
          ...
          className="min-h-[20rem] lg:col-span-5"
        >
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-3 text-sm text-muted-foreground">
                Cash received, plus completed project value where cash has not been logged yet.
              </p>

              <p className="mt-4 text-xs font-medium text-muted-foreground">
                Click to open Financials
              </p>
            </div>
        ...
        <BentoCard className="rounded-3xl border border-border bg-card p-6 lg:col-span-8">
        ...
        <BentoCard className="rounded-3xl border border-border bg-card p-6 lg:col-span-4">
          <div className="mb-5 flex items-start justify-between gap-4">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.22em] text-muted-foreground">
                Sales
          ...
          {loading ? (
            <div className="flex h-52 items-center justify-center rounded-2xl border border-dashed border-border bg-background">
        ...
        <BentoCard className="rounded-3xl border border-border bg-card p-6 lg:col-span-4">
          <div className="flex items-start gap-4">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-blue-500/20 bg-blue-500/10 text-blue-700 dark:text-blue-300">
              <ArrowRight size={20} />
            </div>
        ...
        <BentoCard className="rounded-3xl border border-border bg-card p-6 lg:col-span-4">
          <div className="flex items-start gap-4">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-emerald-500/20 bg-emerald-500/10 text-emerald-700 dark:text-emerald-300">
              <TrendingUp size={20} />
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                {loading
                  ...
                  : conversionRate >= 25
                    ? 'Conversion is moving well. Keep lead follow-ups tight.'
